    ...
    return (
        <div className="container my-4 space=y-4">
            ...
            <div className="space-y-6">
                <div className="flex gap-2 justify-between">
                    <div className="space-y-2 mb-6">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl">
                            Interview : <SuspendedItem item={interview} fallback={<Skeleton className="w-48 h-12" />} result={i => formatDateTime(i.createdAt)} />
                        </h1>
                ...
                <Suspense fallback={<Loader2Icon className="mx-auto animate-spin size-24" />}>
...
async function Messages({ interview }: { interview: Promise<{ humeChatId: string | null }> }) {
    ...
    return (
        <CondensedMessages messages={condensedMessages} user={user} className="max-w-5xl mx-auto" />
    )
}
